...
| --------------- | --------------------------------------------------- | -------------------------------- |
| Static Routing  | Manually configured routes                          | Small, simple networks           |
| Dynamic Routing | Routes learned automatically using protocols        | Large and changing networks      |
| Default Routing | Uses a predefined route when no other route matches | Networks with a single exit path |
