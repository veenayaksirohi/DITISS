...
I also developed a Fake News Detection System using Python. It detects and verifies factual claims made in uploaded videos. It uses Whisper for video transcription, BERT for claim identification, Perplexity AI for claim verification, and Flask APIs for backend communication.

Additionally, I have completed Cisco’s Introduction to Cybersecurity certification and the Docker Foundations Professional Certificate.

I am always eager to learn new technologies and improve my technical skills. I am looking for an opportunity where I can apply my knowledge, gain practical experience, and contribute to the organization.
