...
| Virtualization layer | **Hypervisor** (Type I = bare-metal)     | _(no hypervisor needed)_                                             |
...
> Docker is the _platform_; a container is the _isolated environment_ it creates and manages.
...
You describe _what_ (3 replicas); the **Swarm scheduler** decides _where_.
...
_Notes consolidated from: Containerization fundamentals, Docker platform & architecture, Docker Images (creation, layers, Dockerfile instructions, security), and Docker Swarm (orchestration, nodes, services, tasks, networking)._
